...
FPS_API UScriptStruct* Z_Construct_UScriptStruct_FItemWeaponMaster();
UPackage* Z_Construct_UPackage__Script_FPS();
// End Cross Module References

// Begin ScriptStruct FItemWeaponMaster
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_ItemWeaponMaster;
class UScriptStruct* FItemWeaponMaster::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_ItemWeaponMaster.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_ItemWeaponMaster.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemWeaponMaster, (UObject*)Z_Construct_UPackage__Script_FPS(), TEXT("ItemWeaponMaster"));
	}
	return Z_Registration_Info_UScriptStruct_ItemWeaponMaster.OuterSingleton;
}
template<> FPS_API UScriptStruct* StaticStruct<FItemWeaponMaster>()
{
	return FItemWeaponMaster::StaticStruct();
}
struct Z_Construct_UScriptStruct_FItemWeaponMaster_Statics
{
#if WITH_METADATA
	...
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FItemWeaponMaster>();
	}
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FItemWeaponMaster_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_FPS,
	nullptr,
	&NewStructOps,
	"ItemWeaponMaster",
	Z_Construct_UScriptStruct_FItemWeaponMaster_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemWeaponMaster_Statics::PropPointers),
	sizeof(FItemWeaponMaster),
	alignof(FItemWeaponMaster),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemWeaponMaster_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FItemWeaponMaster_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FItemWeaponMaster()
{
	if (!Z_Registration_Info_UScriptStruct_ItemWeaponMaster.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_ItemWeaponMaster.InnerSingleton, Z_Construct_UScriptStruct_FItemWeaponMaster_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_ItemWeaponMaster.InnerSingleton;
}
// End ScriptStruct FItemWeaponMaster
