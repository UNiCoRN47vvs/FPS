...
class AItemMaster;
//-----------------------------------------------------------------------------------------------------------
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FInitInvWidget, UStorageComponent*, StorageComponent);
//-----------------------------------------------------------------------------------------------------------
...
public:	
	UStorageComponent();
	TArray<FItemInvStruct> GetStorage();
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Inventory Component") TArray<FItemInvStruct> Storage;
};
//-----------------------------------------------------------------------------------------------------------